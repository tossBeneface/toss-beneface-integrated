    ...
    switch (selectedPaymentMethod) {
      case "CARD":
        await payment.requestPayment({
          ...
          successUrl: "http://localhost:3000/payment/success", // 결제 요청이 성공하면 리다이렉트되는 URL
          failUrl: "http://localhost:3000/payment/fail", // 결제 요청이 실패하면 리다이렉트되는 URL
  ...
  return (
    <div className="wrapper">
      <div className="box_section">
        <h1>일반 결제</h1>
        <div id="payment-method" style={{ display: "flex", justifyContent: "space-between", width: "100%" }}>
          ...
          <button id="CULTURE_GIFT_CERTIFICATE" className={`button2 ${selectedPaymentMethod === "CULTURE_GIFT_CERTIFICATE" ? "active" : ""}`} onClick={() => selectPaymentMethod("CULTURE_GIFT_CERTIFICATE")}>
            문화상품권
          </button>
